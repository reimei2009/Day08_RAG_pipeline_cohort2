...
**Nhánh cá nhân:** `nguyenvanchung` / `2A202600647-NguyenVanChung`  
...
- [x] Nhiệm vụ nhóm Task 1–3 (data + code tại root)
- [x] Bài cá nhân Task 1–10
- [x] 35 automated tests (chạy từ thư mục `2A202600647-NguyenVanChung/`)
- [x] Push lên GitHub (`dev`, `2A202600647-NguyenVanChung`, `nguyenvanchung`)
...
- Repo: https://github.com/reimei2009/Day08_RAG_pipeline_cohort2  
- Nhánh dev (nhóm): https://github.com/reimei2009/Day08_RAG_pipeline_cohort2/tree/dev  
- Nhánh cá nhân: https://github.com/reimei2009/Day08_RAG_pipeline_cohort2/tree/2A202600647-NguyenVanChung  
